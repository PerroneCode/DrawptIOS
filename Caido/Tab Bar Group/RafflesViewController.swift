...
class RafflesViewController : UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    {
        view.addSubview(rafflesLabel)
        
        rafflesLabel.leftAnchor.constraint(equalTo: searchTextFieldBackgroundView.leftAnchor).isActive = true
        rafflesLabel.bottomAnchor.constraint(equalTo: searchTextFieldBackgroundView.topAnchor, constant: -10).isActive = true
        rafflesLabel.widthAnchor.constraint(equalTo: searchTextFieldBackgroundView.widthAnchor).isActive = true
        rafflesLabel.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.05).isActive = true
    }
